...
// public class DoubleDummyCodingMap {
...
// 	// private final DCounts[] _array;

// 	public DoubleDummyCodingMap(int init_capacity) {
// 		// _array = new DCounts[nRows];
// 		// _indexes = new int[nRows];
...
// 		if(l == null) {
// 			Bucket ob = _data[ix];
// 			DCounts nv = new DCounts(key);
// 			// _array[index] = nv;
// 			_data[ix] = new Bucket(nv);
// 			_data[ix].n = ob;
// 			_size++;
// 		}
// 		else {
